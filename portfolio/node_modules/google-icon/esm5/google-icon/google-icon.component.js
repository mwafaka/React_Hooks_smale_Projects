...
var GoogleIconComponent = /** @class */ (function () {
    function GoogleIconComponent() {
    }
    GoogleIconComponent.prototype.ngOnInit = function () {
        if (!this.name) {
